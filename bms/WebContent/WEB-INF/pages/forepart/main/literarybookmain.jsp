...
.book_new_state dl h5 a{
color: #fff;
margin-left: -109px;
}
.book_new_state dl  dd b{
					...
					<div id="myCarousel" class="carousel slide">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img
									src="<%=request.getContextPath()%>/img/literaryimg/letter1.png"
									style="width: 596px; height: 307px;" alt="First slide">
							</div>
							<div class="item">
								<img
									src="<%=request.getContextPath()%>/img/literaryimg/letter2.png"
									style="width: 596px; height: 307px;" alt="Second slide">
							</div>
							<div class="item">
								<img
									src="<%=request.getContextPath()%>/img/literaryimg/letter3.png"
									style="width: 596px; height: 307px;" alt="Third slide">
							</div>
							<div class="item">
								<img
									src="<%=request.getContextPath()%>/img/literaryimg/letter5.png"
									style="width: 596px; height: 307px;" alt="Third slide">
							</div>
						</div>
						<!-- 轮播（Carousel）导航 -->
					...
					<div class="book_new_state">
						<dl>
							...
							<dd style="margin-top: -7px"> 
								    <b></b>
								    <a href="https://channel.jd.com/1713-3258.html" title="小说馆" target="_blank" clstag="channel|keycount|387|ZX1_22_2">小说馆</a>
	  						</dd>
	  						<dd> 
    <b></b>
    <a href="#" title="文学馆" target="_blank" clstag="channel|keycount|387|ZX1_22_3">文学馆</a>
  </dd>
  <dd> 
    <b></b>
    <a href="#" title="青春馆" target="_blank" clstag="channel|keycount|387|ZX1_22_4">青春馆</a>
  </dd>
					...
					<div class="book_right_button">
						<div id="myCarousel-class" class="carousel slide">
							...
							<div class="carousel-inner">
								<div class="item active">
									<li class="line4"><c:forEach items="${listLiter}"
											var="lit" begin="4" end="4">
											<a class="img" href="#" target="_blank"> <img
												src="<%=request.getContextPath()%>/img/literaryimg/literature1.jpg"
											...
											<p class="shopping">
												<a href="adds_litery?bmLiteraryBook.bookId=${lit.bookId }">加入购物车</a>
											</p>
										</c:forEach></li>
								</div>
								<div class="item">
									<li class="line4"><c:forEach items="${listLiter}"
											...
											<a class="img" href="#" target="_blank"> <img
												src="<%=request.getContextPath()%>/img/literaryimg/literature2.jpg"
												style="width: 200px; height: 100px;" alt="增长黑客：如何低成本实现爆发式成长">
											</a>
											<p class="name">
												<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
								...
								<div class="item">
									<li class="line4"><c:forEach items="${listLiter}"
											...
											<a class="img" href="#" target="_blank"> <img
												src="<%=request.getContextPath()%>/img/literaryimg/literature3.jpg"
												style="width: 200px; height: 100px;" alt="增长黑客：如何低成本实现爆发式成长">
											</a>
											<p class="name">
												<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
			...
			<div id="bookshowcenter">
				...
				<ul class="booktop">
					...
					<li class="bookleftshow"><c:forEach items="${listLiter}"
							var="lit" begin="1" end="1">
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/literaryimg/literature4.jpg"
					...
					<li class="bookleftshow"><c:forEach items="${listLiter}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/literaryimg/literature5.jpg"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
					...
					<li class="bookleftshow"><c:forEach items="${listLiter}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/literaryimg/literature6.jpg"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
				...
				<ul class="bookbotton">
					<c:forEach items="${listLiter}" var="lit" begin="0" end="0">
						<li class="bookbottonshow"><a class="img" href="#"
							target="_blank"> <img
								src="<%=request.getContextPath()%>/img/literaryimg/literature7.jpg"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
						</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
					...
					<li class="bookbottonshow"><c:forEach items="${listLiter}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/literaryimg/literature8.jpg"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
					...
					<li class="bookbottonshow"><c:forEach items="${listLiter}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/literaryimg/literature9.jpg"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor}</a>
