			...
			<div id="boxcenter">
					...
					<div id="myCarousel" class="carousel slide">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img
									src="<%=request.getContextPath()%>/img/Childimg/juvenile1.png"
									style="width: 596px; height: 307px;" alt="First slide">
							</div>
							<div class="item">
								<img
									src="<%=request.getContextPath()%>/img/Childimg/juvenile2.png"
									style="width: 596px; height: 307px;" alt="Second slide">
							</div>
							<div class="item">
								<img
									src="<%=request.getContextPath()%>/img/Childimg/juvenile3.png"
									style="width: 596px; height: 307px;" alt="Third slide">
							</div>
							<div class="item">
								<img
									src="<%=request.getContextPath()%>/img/Childimg/juvenile4.png"
									style="width: 596px; height: 307px;" alt="Third slide">
							</div>
						</div>
						<!-- 轮播（Carousel）导航 -->
				...
				<ul class="right">
					...
					<div class="book_new_state">
						<h5><a href="#">点这里：创建陪伴计划宝贝档案</a></h5>
						<a href="#"><img alt="" src="<%=request.getContextPath()%>/img/Childimg/child10.png"></a>
					</div>
					<!--轮播物品图  -->
					<div class="book_right_button">
						<div id="myCarousel-class" class="carousel slide">
							...
							<div class="carousel-inner">
								<div class="item active">
									<li class="line4"><c:forEach items="${listChild}"
											var="lit" begin="4" end="4">
											<a class="img" href="#" target="_blank"> <img
												src="<%=request.getContextPath()%>/img/Childimg/child1.webp"
											...
											<p class="shopping">
												<a href="adds_child?bmChildBook.bookId=${lit.bookId }">加入购物车</a>
											</p>
										</c:forEach></li>
								</div>
								<div class="item">
									<li class="line4"><c:forEach items="${listChild}"
											...
											<a class="img" href="#" target="_blank"> <img
												src="<%=request.getContextPath()%>/img/Childimg/child2.webp"
												style="width: 200px; height: 100px;" alt="增长黑客：如何低成本实现爆发式成长">
											</a>
											<p class="name">
												<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
								...
								<div class="item">
									<li class="line4"><c:forEach items="${listChild}"
											...
											<a class="img" href="#" target="_blank"> <img
												src="<%=request.getContextPath()%>/img/Childimg/child3.webp"
												style="width: 200px; height: 100px;" alt="增长黑客：如何低成本实现爆发式成长">
											</a>
											<p class="name">
												<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
			...
			<div id="bookshowcenter">
				...
				<ul class="booktop">
					...
					<li class="bookleftshow"><c:forEach items="${listChild}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/Childimg/child4.webp"
					...
					<li class="bookleftshow"><c:forEach items="${listChild}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/Childimg/child5.webp"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
					...
					<li class="bookleftshow"><c:forEach items="${listChild}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/Childimg/child6.webp"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
				...
				<ul class="bookbotton">
					<c:forEach items="${listChild}" var="lit" begin="0" end="0">
						<li class="bookbottonshow"><a class="img" href="#"
							target="_blank"> <img
								src="<%=request.getContextPath()%>/img/Childimg/child7.webp"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
						</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
					...
					<li class="bookbottonshow"><c:forEach items="${listChild}"
							var="lit" begin="10" end="10">
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/Childimg/child8.webp"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor }</a>
					...
					<li class="bookbottonshow"><c:forEach items="${listChild}"
							...
							<a class="img" href="#" target="_blank"> <img
								src="<%=request.getContextPath()%>/img/Childimg/child9.webp"
								style="width: 150px; height: 176px;" alt="增长黑客：如何低成本实现爆发式成长">
							</a>
							<p class="name">
								<a href="#" target="_blank" style="">作者：${lit.bookAuthor}</a>
