...
<a href="login.jsp" style="float: right;margin-top:-60px;color:#fff" class="btn btn-danger" onclick="javascript:return exit()">退出系统</a>
	...
	<div id="right">
		...
		<h3>图书种类添加</h3>
		<c:if test="${bankadd==1 }">
			<form action="bm_bankadds" method="post"
				class="table table-striped table-bordered table-hover">
				<input type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本种类" id="bmBookname"
					name="bmkind.bmBookname" value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入添加者：" id="bmName" name="bmkind.bmName"
					value="${loginname}" readonly="readonly" /><br /> <input
					type="submit" class="btn btn-danger" id="submit" value="提交" />
			</form>
			<h3>
				<a href="bookbank">返回种类列表</a>
			</h3>
		</c:if>
