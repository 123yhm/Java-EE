	...
	<div class="right">
		<div id="user">
			...
			<div class="active">
				...
				<span class="boxBank"> <a href="bookshow">库一</a><a
					href="bookshowtwo">库二</a><a href="bookshowthree">库三</a>
				</span>
				...
				<c:if test="${!empty bookList }">
					<font class="book">
						<form action="#" method="post">
							...
							<input type="text" id="textbook" class="form-control"
								placeholder="请输入查找的书名" name="bookNames" />
				...
				<table id="bookbox" border="1px solid red" cellpadding="0px"
					...
					<c:if test="${!empty bookList }">
						<h2>库一</h2>
						<!--库一  -->
						<c:forEach items="${bookList }" var="emp" varStatus="status">
							<tr id="bookr2">
								<td><a href="bm_getid?bmLiteraryBook.bookId=${emp.bookId}"
									style="color: red;">${status.count}</a></td>
								<td>${emp.bookIsbn }</td>
								<td>${emp.bookName }</td>
								<td>${emp.bookAuthor }</td>
								<td>${emp.bookRepertory }</td>
								<td style="color: red;">￥${emp.bookPrice }</td>
								<td>${emp.bookTime }</td>
								<td>${emp.bookPress }</td>
								<td>${emp.bookAddres }</td>
								<td><a href="bm_update?bmLiteraryBook.bookId=${emp.bookId}">
								...
								<td><a href="bm_delete?bmLiteraryBook.bookId=${emp.bookId}"
						...
						<tr style="font-size: 20px; font-weight: bold;">
							<th colspan="2" style="text-align: center;"><a
								style="color: red;" href="bookshow?page=1"><<首页>></a></th>
							<th colspan="2" style="text-align: center;"><c:if
									test="${page-1>=1 }">
									<a style="color: red;" href="bookshow?page=${page-1 }">上一页</a>
								</c:if></th>
							<th colspan="2" style="text-align: center;"><a
								style="color: red;">当前第${page}页</a></th>
							<th colspan="2" style="text-align: center;"><c:if
									test="${maxpage>page }">
									<a style="color: red;" href="bookshow?page=${page+1 }">下一页</a>
								</c:if></th>
							<th colspan="3" style="text-align: center;"><a
								style="color: red;" href="bookshow?page=${maxpage}"><<尾页>></a></th>
					...
					<c:if test="${!empty bookListtwo }">
						<h2>库二</h2>
						<!--库二  -->
						<c:forEach items="${bookListtwo }" var="emp" varStatus="status">
							<tr id="bookr2">
								<td><a href="bm_getChild?bmChildBook.bookId=${emp.bookId}"
									style="color: red;">${status.count}</a></td>
								<td>${emp.bookIsbn }</td>
								<td>${emp.bookName }</td>
								<td>${emp.bookAuthor }</td>
								...
								<td>${emp.bookAddres }</td>
								<td><a
									href="bm_updateChild?bmChildBook.bookId=${emp.bookId}">
										<button type="button" class="btn btn-danger">
											<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
											修改
										</button>
								...
								<!-- 获取绝对路径在找到emp--delete--传id和页码值 -->
								<td><a
									href="bm_deleteChild?bmChildBook.bookId=${emp.bookId}"
									onclick="javascript:return del()">
										<button type="button" class="btn btn-danger">
											<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
											删除
						...
						<tr style="font-size: 20px; font-weight: bold;">
							<th colspan="2" style="text-align: center;"><a
								style="color: red;" href="bookshowtwo?page=1"><<首页>></a></th>
							<th colspan="2" style="text-align: center;"><c:if
									test="${page-1>=1 }">
									<a style="color: red;" href="bookshowtwo?page=${page-1 }">上一页</a>
								</c:if></th>
							<th colspan="2" style="text-align: center;"><a
								style="color: red;">当前第${page}页</a></th>
							<th colspan="2" style="text-align: center;"><c:if
									test="${maxpage>page }">
									<a style="color: red;" href="bookshowtwo?page=${page+1 }">下一页</a>
								</c:if></th>
							<th colspan="3" style="text-align: center;"><a
								style="color: red;" href="bookshowtwo?page=${maxpage}"><<尾页>></a></th>
					...
					<c:if test="${!empty bookListthree }">
						<h2>库三</h2>
						<!--库三  -->
						<c:forEach items="${bookListthree }" var="emp" varStatus="status">
							<tr id="bookr2">
								<td><a href="bm_getidIt?bmItBook.bookId=${emp.bookId}"
									style="color: red;">${status.count}</a></td>
								<td>${emp.bookIsbn }</td>
								<td>${emp.bookName }</td>
								<td>${emp.bookAuthor }</td>
								...
								<td>${emp.bookPress }</td>
								<td>${emp.bookAddres }</td>
								<td><a href="bm_updateIt?bmItBook.bookId=${emp.bookId}">
										<button type="button" class="btn btn-danger">
											<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
											修改
										</button>
								...
								<!-- 获取绝对路径在找到emp--delete--传id和页码值 -->
								<td><a href="bm_deleteIt?bmItBook.bookId=${emp.bookId}"
									onclick="javascript:return del()">
										<button type="button" class="btn btn-danger">
											<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
											删除
						...
						<tr style="font-size: 20px; font-weight: bold;">
							<th colspan="2" style="text-align: center;"><a
								style="color: red;" href="bookshowthree?page=1"><<首页>></a></th>
							<th colspan="2" style="text-align: center;"><c:if
									test="${page-1>=1 }">
									<a style="color: red;" href="bookshowthree?page=${page-1 }">上一页</a>
								</c:if></th>
							<th colspan="2" style="text-align: center;"><a
								style="color: red;">当前第${page}页</a></th>
							<th colspan="2" style="text-align: center;"><c:if
									test="${maxpage>page }">
									<a style="color: red;" href="bookshowthree?page=${page+1 }">下一页</a>
								</c:if></th>
							<th colspan="3" style="text-align: center;"><a
								style="color: red;" href="bookshowthree?page=${maxpage}"><<尾页>></a></th>
						</tr>
					</c:if>
