...
<a href="login.jsp" style="float: right;margin-top:-60px;color:#fff" class="btn btn-danger" onclick="javascript:return exit()">退出系统</a>
	...
	<div id="right">
		...
		<h3>图书添加</h3>
		<c:if test="${Literary==1 }">
			<form action="bm_adds" method="post"
				class="table table-striped table-bordered table-hover">
				<input type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本编号：" id="bookIsbn"
					name="bmLiteraryBook.bookIsbn" value="" /><br /> <input
					type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本名称：" id="bookName"
					name="bmLiteraryBook.bookName" value="" /><br /> <input
					type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本作者：" id="bookAuthor"
					name="bmLiteraryBook.bookAuthor" value="" /><br /> <input
					type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本数量：" id="bookRepertory"
					name="bmLiteraryBook.bookRepertory" value="" /><br /> <input
					type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本价格：" id="bookPrice"
					name="bmLiteraryBook.bookPrice" value="" /><br /> <input
					type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本出版社：" id="bookPress"
					name="bmLiteraryBook.bookPress" value="" /><br /> <input
					type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本地址：" id="bookAddres"
					name="bmLiteraryBook.bookAddres" value="" /><br /> <input
					type="submit" class="btn btn-danger" id="submit" value="提交" />
			</form>
			<h3>
		...
		<c:if test="${Child==2 }">
			<form action="bm_addsChild" method="post"
				class="table table-striped table-bordered table-hover">
				<input type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本编号：" id="bookIsbn"
					name="bmChildBook.bookIsbn" value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本名称：" id="bookName" name="bmChildBook.bookName"
					value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本作者：" id="bookAuthor"
					name="bmChildBook.bookAuthor" value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本数量：" id="bookRepertory"
					name="bmChildBook.bookRepertory" value="" /><br /> <input
					type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本价格：" id="bookPrice"
					name="bmChildBook.bookPrice" value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本出版社：" id="bookPress" name="bmChildBook.bookPress"
					value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本地址：" id="bookAddres"
					name="bmChildBook.bookAddres" value="" /><br /> <input
					type="submit" class="btn btn-danger" id="submit" value="提交" />
			</form>
			<h3>
		...
		<c:if test="${It==3 }">
			<form action="bm_addsIt" method="post"
				class="table table-striped table-bordered table-hover">
				<input type="text" style="width: 300px; margin: auto;"
					class="form-control" placeholder="请输入书本编号：" id="bookIsbn"
					name="bmItBook.bookIsbn" value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本名称：" id="bookName" name="bmItBook.bookName"
					value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本作者：" id="bookAuthor" name="bmItBook.bookAuthor"
					value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本数量：" id="bookRepertory"
					name="bmItBook.bookRepertory" value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本价格：" id="bookPrice" name="bmItBook.bookPrice"
					value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本出版社：" id="bookPress" name="bmItBook.bookPress"
					value="" /><br /> <input type="text"
					style="width: 300px; margin: auto;" class="form-control"
					placeholder="请输入书本地址：" id="bookAddres" name="bmItBook.bookAddres"
					value="" /><br /> <input type="submit" class="btn btn-danger"
					id="submit" value="提交" />
			</form>
			<h3>
