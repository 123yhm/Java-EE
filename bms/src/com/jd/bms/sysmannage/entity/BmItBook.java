 ...
 */
@Entity
@Table(name = "bm_it_book")
public class BmItBook implements Serializable {
	/**
	 * @Fields serialVersionUID : TODO(用一句话描述这个变量表示什么)
	 */
	private static final long serialVersionUID = -3469217590785422193L;
	@Id
	@Column(name = "book_id")
	...
	public BmItBook(Integer bookId, String bookIsbn, String bookName,
